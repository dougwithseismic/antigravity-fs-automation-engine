...
The `@antigravity/client-sdk` enables your frontend applications to participate in hybrid workflows. It handles the "Hot Potato" protocol, executing client-side nodes and communicating with the Antigravity API.
