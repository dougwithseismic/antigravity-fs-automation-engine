...
The `@antigravity/client-sdk/react` package provides React hooks for integrating workflows into your UI.

Instead of manually managing workflow state, the React SDK gives you hooks that handle execution, state updates, and pause/resume cycles automatically. Your components just render the current workflow state and respond to user interactions.

Perfect for building interactive workflows that feel native to your app.
