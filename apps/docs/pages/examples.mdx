...
description: Real-world workflow examples using Antigravity
---

# Workflow Examples

## 1. Server-Only Workflow (API Integration)

**Use Case**: Scheduled data sync from external API to database.
